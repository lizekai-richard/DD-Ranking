...
save_path_soft = f"./results/{dataset}/{model_name}/IPC{ipc}/rded_cifar100_ipc1.csv"
convd4_soft_obj = LabelRobustScoreSoft(
    ...
    teacher_model_names=["ConvNet-3-BN"],
    ...
    random_data_path="./random_data/RDED/CIFAR100/IPC1/"
)
